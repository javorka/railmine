...
class SprintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post sprints_url, params: { sprint: { from: @sprint.from, name: @sprint.name, project_id: @sprint.project_id, to: @sprint.to } }
    end
  ...
  test "should update sprint" do
    patch sprint_url(@sprint), params: { sprint: { from: @sprint.from, name: @sprint.name, project_id: @sprint.project_id, to: @sprint.to } }
